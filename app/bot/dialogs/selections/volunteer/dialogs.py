...
1. <b>Только в день форума</b> (11 апреля 2026)
2. <b>С 9 по 11 апреля 2026 (9 и 10 — подготовка к форуму частичная занятость + 11 апреля – форум КБК с 9:00 до 21:00)</b>

За помощь 9 и 10 апреля волонтёров ждут доп.баллы для ПГАС!"""
        ),
        Column(
