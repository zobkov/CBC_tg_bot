...
volunteer_dialog = Dialog(
    ...
    Window(
        ...
        Row(
            Button(Const("Начать"), id="vol_start", on_click=on_start_clicked),
            Cancel(Const("Назад")),
        ),
    ...
    Window(
        Const(
            ...
            "Если ты из СПбГУ, то надо использовать корпоративную почту "
            "(должна заканчиваться на @spbu.ru, @student.spbu.ru или @gsom.spbu.ru)\n\n"
    ...
    Window(
        ...
        Column(
            Button(Const("1. Общий волонтерский функционал"), id="vol_func_general", on_click=on_function_general),
    ...
    # ── GENERAL_1 ─────────────────────────────────────────────────────────
    Window(
        Const("<b>Посещал(а) ли ты когда-то КБК в качестве участника или волонтера?</b>"),
        Column(
            Button(Const("1. Да, в качестве участника"), id="vol_g1_guest", on_click=on_general_1_guest),
            Button(Const("2. Да, в качестве волонтера"), id="vol_g1_volunteer", on_click=on_general_1_volunteer),
            Button(Const("3. Да, как волонтер и как участник"), id="vol_g1_both", on_click=on_general_1_both),
    ...
    Window(
        Const(
            "<b>Как ты думаешь, какие ключевые моменты и эмоции важно запечатлеть фотографу на КБК, "
            "чтобы передать атмосферу форума?</b>"
        ),
    ...
    Window(
        Const(
            "<b>Есть ли что-то, что мы не спросили, но что важно, чтобы мы о тебе знали? "
            "Или у тебя есть вопросы к нам?</b>"
        ),
    ...
    Window(
        ...
        Button(Const("В главное меню"), id="vol_end_home", on_click=on_go_home),
