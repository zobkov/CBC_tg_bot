...
КБК — это не только однодневный форум в апреле, но и активная среда, которая включает множество онлайн-мероприятий в течение года. 

Мы приглашаем экспертов из разных сфер, чтобы они делились своими знаниями и опытом, помогая участникам расти и развивать проекты!

"""

_SCHEDULE_HEADER = "<b>📅 Ближайшие онлайн-мероприятия:</b>\n\n"
