...
_WANT_REG_TEXT = """Привет! Ты в официальном боте КБК — это твой главный помощник для участия в форуме КБК и всех наших проектах. Здесь ты можешь следить за анонсами лекций и событий и получать море другой полезной информации.

Если тебе интересно познавать Китай не по учебникам, то самое время присоединиться к КБК!

Ты хочешь зарегестрироваться на Форум КБК’26? Если ты хочешь пройти отбор волонтеров, то нажимай «Нет» или /menu"""
