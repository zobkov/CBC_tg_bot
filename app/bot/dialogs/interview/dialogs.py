...
interview_dialog = Dialog(
    ...
    Window(
        Multi(
            ...
            Const("Теперь тебе нужно выбрать удобный день и время, чтобы пообщаться с руководителем отдела. Это финальный шаг перед тем, как стать частью команды КБК!\n", when="has_approval"),
    ...
    Window(
        Multi(
            ...
            Format("📅 Твоя текущая запись: {booking_date} в {booking_time}\n"),
