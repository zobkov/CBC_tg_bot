...
first_stage_dialog = Dialog(
    ...
    # Загрузка резюме
    Window(
        Const("Прикрепи своё актуальное резюме (PDF, DOC, DOCX). Это поможет нам больше узнать про твои навыки и опыт."
    ...
    Window(
        Const("📄 Загрузите новое резюме (PDF, DOC, DOCX, размер до 15 МБ):"),
        MessageInput(
            content_types=[ContentType.DOCUMENT],
    ...
    Window(
        Const("🎉 <b>Готово!</b>\n\n"
              ...
              "Следи за статус заявки в личном кабинете и за анонсами в нашем телеграм-канале"),
        Button(Const("🏠 В главное меню"), id="go_to_menu", on_click=go_to_menu),
